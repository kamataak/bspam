...
`bspam` is an R package that fit a speed-accuracy psychometric model for count outcome data. For example, this R package allows model-based calibration and scoring for oral reading fluency (ORF) assessment data.
