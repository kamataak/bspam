...
Before installation, make sure that R and the system tools required to build R packages are available on your computer. On Windows, this may require Rtools; on macOS, the Xcode Command Line Tools may be required. Some `bspam`  dependencies, particularly those used for Bayesian estimation, may require these compilation tools.
...
Wang K, Kamata A, Potgieter C, Nese J, Kara Y, Somsong S, Qiao X (2023). bspam: Speed-Accuracy Psychometric Modeling for Binomial Count Outcome Data with R. R package version 1.2.6, [https://github.com/kamataak/bspam](https://github.com/kamataak/bspam)
